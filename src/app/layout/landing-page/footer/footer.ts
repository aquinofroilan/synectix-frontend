            ...
            <div class="max-w-7xl sm:px-6 lg:px-8 py-12 w-11/12">
                <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div>
                        ...
                        <ul class="space-y-2">
                            <li>
                                <app-link routerLink="/support/help">Help Center</app-link>
                            </li>
                            <li>
                                <app-link routerLink="/support/documentation">Documentation</app-link>
                            </li>
                            <li>
                                <app-link routerLink="/support/api">API Reference</app-link>
                            </li>
                            <li>
                                <app-link routerLink="/support/training">Training</app-link>
                            </li>
                            <li>
                                <app-link routerLink="/support/contact">Contact Us</app-link>
                            </li>
                            <li>
                                <app-link routerLink="/support/status">System Status</app-link>
                            </li>
                        </ul>
                    </div>
                </div>
